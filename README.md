...
Welcome to my portfolio. I focus on building functional, high-quality applications with a priority on user experience and performance.

[View on Google Play Store](https://play.google.com/store/apps/dev?id=8797132005650317166)
...
a high-performance image utility designed to handle media optimization without compromising visual integrity.

* **Features**:
    * Batch processing support for high-volume workflows.
    * Lossless and lossy compression algorithms to reduce file size from MB to KB.
    * Privacy-centric design: All processing occurs locally on-device.
...
A clean, reliable calculation tool built with accuracy and simplicity in mind.
